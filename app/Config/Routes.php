...
$routes->group('profil', function ($routes) {
    ...
    $routes->get('bakat-minat', 'Profil::bakatMinat');
...
$routes->group('alumni', function ($routes) {
    $routes->get('/', 'AlumniPublic::index');
    $routes->get('kampus/(:num)', 'AlumniPublic::kampus/$1');
    $routes->get('daftar', 'AlumniPublic::daftar');
    $routes->post('simpan-mandiri', 'AlumniPublic::simpanMandiri');
});
...
// ==========================================
// 🛡️ RUTE ADMIN (DILINDUNGI FILTER AUTH)
// ==========================================
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->group('bakat-minat', function ($routes) {
        $routes->get('/', 'Admin\BakatMinat::index');
        $routes->get('create', 'Admin\BakatMinat::create');
