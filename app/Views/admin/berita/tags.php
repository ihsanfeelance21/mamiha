                        ...
                        foreach ($tags as $t) : ?>
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                                ...
                                <td class="p-3 text-center">
                                    <form action="<?= base_url('admin/berita/hapusTag/' . $t['id']) ?>" method="post" onsubmit="return confirm('Yakin ingin menghapus tag ini?')" style="display:inline"><?= csrf_field() ?><button type="submit" class="text-red-500 hover:text-red-700 text-sm font-medium transition flex items-center justify-center gap-1">
