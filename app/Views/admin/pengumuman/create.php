...
<div class="p-6 md:p-8 max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Buat informasi baru untuk ditampilkan di website</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
        <form action="<?= base_url('admin/pengumuman/store') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="judul" id="judul" required placeholder="Contoh: Pengambilan Raport Semester Ganjil" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:bg-white focus:border-[#00A859] focus:ring-2 focus:ring-[#00A859]/20 transition-all">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_publish" id="tanggal_publish" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:bg-white focus:border-[#00A859] focus:ring-2 focus:ring-[#00A859]/20 transition-all cursor-pointer">
                </div>
            </div>

            <div class="mb-6">
                <label for="gambar" class="block text-sm font-bold text-gray-700 mb-2">Poster / Gambar (Opsional)</label>
                ...
                <p class="text-xs text-gray-500 mt-1.5"><i class="fa-solid fa-circle-info text-blue-500 mr-1"></i> Format JPG/PNG. Biarkan kosong jika tidak ada poster.</p>
            </div>

            <div class="mb-8">
                <label for="konten" class="block text-sm font-bold text-gray-700 mb-2">Isi Pengumuman <span class="text-red-500">*</span></label>
                <textarea name="konten" id="konten" rows="8" required placeholder="Tuliskan detail pengumuman di sini..." class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:bg-white focus:border-[#00A859] focus:ring-2 focus:ring-[#00A859]/20 transition-all"></textarea>
            </div>
            ...
            <div class="flex justify-end pt-4 border-t border-gray-100">
                <button type="submit" class="bg-[#00A859] hover:bg-[#0B4A2D] text-white px-8 py-2.5 rounded-xl font-bold transition-colors shadow-sm flex items-center gap-2">
                    <i class="fa-solid fa-paper-plane"></i> Publish Pengumuman
                </button>
            </div>
