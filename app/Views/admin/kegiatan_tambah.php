...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Tambahkan kegiatan ekstrakurikuler atau agenda sekolah</p>
        </div>
    </div>
        ...
        <form action="<?= base_url('admin/kegiatan/simpan') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="konten" name="konten" rows="6" required
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:bg-white focus:border-[#00A859] focus:ring-2 focus:ring-[#00A859]/20 transition-all"><?= old('konten') ?></textarea>
            </div>
            <div class="mb-6">
                <label for="gambar" class="block text-sm font-bold text-gray-700 mb-2">Foto Kegiatan (Opsional)</label>
                ...
                <div id="preview-wrap" class="hidden mt-3">
                    ...
                    <button type="button" onclick="document.getElementById('gambar').value=''; document.getElementById('preview-wrap').classList.add('hidden')" class="text-xs text-red-500 mt-2">Hapus preview</button>
                </div>
                <p class="text-xs text-gray-500 mt-2">Max 5MB, JPG/PNG/WebP. Kosongkan jika tidak ada foto.</p>
            </div>
            <div class="flex justify-end pt-4 border-t border-gray-100">
                <button type="submit" class="bg-[#00A859] hover:bg-[#0B4A2D] text-white px-8 py-2.5 rounded-xl font-bold transition-colors shadow-sm flex items-center gap-2">
                    <i class="fa-solid fa-save"></i> Simpan Kegiatan
                </button>
            </div>
        </form>
    </div>
