                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="p-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="<?= base_url('admin/galeri-video/delete/' . $item['id']) ?>" method="post" onsubmit="return confirm('Yakin ingin menghapus video ini?')" style="display:inline"><?= csrf_field() ?><button type="submit" class="w-8 h-8 rounded-lg bg-red-50 text-red-600 flex items-center justify-center hover:bg-red-600 hover:text-white transition-colors">
